...
public class Juggler extends JComponent implements Runnable, PropertyChangeListener, DesignMode {
	...
	/**
	 * This is an internal utility method to load GIF icons. It takes the name of a
	 * resource file associated with the current object's class-loader and loads a
	 * GIF image from that file.
	 * <p>
	 * 
	...
	/**
	 * An event handling method that calls startJuggling. This method can be used to
	 * connect a Button or a MenuItem to the Juggler.
	 *
	 */
	...
	/**
	 * This method can be used to connect a Button or a MenuItem to the
	 * Juggler.stopJuggling method.
	 */
	...
	/*
	 * If switching to runtime, turn off method tracing if it was enabled. If
	 * switching to design time and debugging is true, then enable method tracing if
