...
/**
 * Not in the Learning Java manual. A set of classes to parse, represent and
 * display Chemical compounds in .xyz format (see
...
class Atom {
	...
	private synchronized void Setup() {
		...
		for (int r = 0; r < nBalls; r++) {
			...
			balls[r] = panel.createImage(new MemoryImageSource(R * 2, R * 2, model, data, 0, R * 2));
		}
	}
