...
/**
 * Not in the Learning Java manual. A fairly conventional 3D matrix object that
 * can transform sets of 3D points and perform a variety of manipulations on the
 * transform.
 */
class Matrix3D {
	float xx, xy, xz, xo;
	 ...
	 * floating point. Three successive entries in the array constitute a point. tv
	 * ends up holding the transformed points as integers; three successive entries
	 * per point
	 */
	...
	public String toString() {
		return ("[" + xo + "," + xx + "," + xy + "," + xz + ";" + yo + "," + yx + "," + yy + "," + yz + ";" + zo + ","
				+ zx + "," + zy + "," + zz + "]");
	}
}
