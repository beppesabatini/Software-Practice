...
public class DialBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		try {
			PropertyDescriptor value = new PropertyDescriptor("value", Dial.class);
			PropertyDescriptor minimum = new PropertyDescriptor("minimum", Dial.class);
			PropertyDescriptor maximum = new PropertyDescriptor("maximum", Dial.class);
	...
	/*
	 * public BeanDescriptor getBeanDescriptor() { return new BeanDescriptor(
	 * Dial.class ); }
	 */
