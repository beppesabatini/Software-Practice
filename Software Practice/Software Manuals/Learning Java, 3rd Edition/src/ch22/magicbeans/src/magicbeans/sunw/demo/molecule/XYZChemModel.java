...
class XYZChemModel {
	...
	synchronized void paint(java.awt.Graphics g) {
		...
		/*
		 * I use a bubble sort since from one iteration to the next, the sort order is
		 * pretty stable, so I just use what I had last time as a "guess" of the sorted
		 * order. With luck, this reduces O(N log N) to O(N)
		 */
