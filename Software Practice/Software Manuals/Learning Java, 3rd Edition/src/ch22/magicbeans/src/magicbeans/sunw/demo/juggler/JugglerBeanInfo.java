...
public class JugglerBeanInfo extends SimpleBeanInfo {
	...
	public PropertyDescriptor[] getPropertyDescriptors() {
		try {
			PropertyDescriptor animationRate = new PropertyDescriptor("animationRate", beanClass);

			PropertyDescriptor name = new PropertyDescriptor("name", beanClass);

			PropertyDescriptor juggling = new PropertyDescriptor("juggling", beanClass);
	...
	private final static Class<Juggler> beanClass = Juggler.class;
}
