 ...
 * the {@linkplain gof.designpatterns.Composite Composite} design pattern,
 * because it is the abstract root object for a hierarchy of different subclass
 * Nodes, which have been generalized to the point at which they can all be
 * handled in a similar manner. Or, that's the plan at least. For now it's just
 * a non-functional stub.</div>
 * 
