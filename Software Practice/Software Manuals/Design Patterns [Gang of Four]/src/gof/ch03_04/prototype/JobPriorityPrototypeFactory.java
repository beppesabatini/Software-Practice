 ...
 * {@linkplain Prototype} design pattern and the {@linkplain Singleton} design
 * pattern. This is a Prototype (a little like a clone manager), because it
 * stores the original results of expensive calculations--prioritizing different
 * jobs--and clones and dispenses copies of the results as required. It is a
 * Singleton, because the same (expensive) calculations are relevant everywhere,
 * and so are stored in one unique instance of an object, which is widely
 * accessible. The UML Diagram is below.
 * <p/>
