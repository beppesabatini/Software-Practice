 ...
 */
public class UserNotificationBackgroundJob {
	public void run() throws InterruptedException {

		System.out.println("UserNotificationBackgroundJob is waking up...");
		...
		BackgroundJobPriority adPriorities = priorities.getUserNotificationJobPriority();
		System.out.println(adPriorities.toString());
		System.out.println("");
		Thread.sleep(2000);

		System.out.println("Now beginning CPU-intensive calculations for User Notifications...");
		Thread.sleep(2000);
	...
	public static class Demo {
		public static void main(String[] args) throws InterruptedException {
			new UserNotificationBackgroundJob().run();
		}
	}
}
