...
/**
 * From Java Examples in a Nutshell, 3rd Edition, pp. 31-32. A class to compute
 * the running average of numbers passed to it.
 */
public class Averager {
	...
	/**
	 * This nested class is a simple test program we can use to check that our code
	 * works correctly.
	 **/
