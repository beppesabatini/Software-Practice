...
/**
 * From Java Examples in a Nutshell, 3rd Edition, pp. 29-31. This class
 * represents complex numbers, and defines methods for performing arithmetic on
 * complex numbers.
 **/
public class ComplexNumber {
	/**
	 * These are the instance variables. Each ComplexNumber object holds two double
	 * values, known as x and y. They are private, so they are not accessible from
	 * outside this class. Instead, they are available through the real() and
	 * imaginary() methods below.
	 */
	private double x, y;
	...
	/**
	 * This method converts a ComplexNumber to a string. This is a method of Object
	 * that we override so that complex numbers can be meaningfully converted to
	 * strings, and so they can conveniently be printed out with
	 ...
	 * "current instance" or "this" object. Use it like this:
	 * <p><pre>
	...
	/**
	 * This is a non-static instance method by the same name. It adds the specified
	 * complex number to the current complex number. Use it like this:
	 * <p><pre> 
